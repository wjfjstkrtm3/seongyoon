...
<div id="content">
	...
	<p class="article-comment margin-small">
		<a class="btn-list button" href="notice.db">목록</a> <a
			class="btn-edit button" href="noticeEdit.db?seq=${notice.seq}">수정</a>
		<a class="btn-del button" href="noticeDel.db?seq=${notice.seq}">삭제</a>
	</p>
