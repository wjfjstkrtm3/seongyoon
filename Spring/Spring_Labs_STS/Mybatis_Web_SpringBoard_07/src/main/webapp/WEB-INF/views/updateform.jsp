		...
		<table width="600">
			<tr>
				...
				<td><input type="hidden" name="pg" value="${pg}" /> <input
					type="hidden" name="num" value="${b.num}" /> <input type="text"
					name="name" maxlength="5" size="12" value="${b.name}" /></td>
			</tr>
			...
			<tr>
				<th>내용</th>
				<td><textarea name="content" rows="5" cols="50">${b.content}</textarea>
				</td>
			</tr>
			<tr>

				<td colspan="2"><input type="button" value="수정"
					onclick="board_update()" /> <input type="reset" value="취소" /></td>
			</tr>
