...
2. 처리 해주세요 (글쓰기 처리) writeok.do


/article/newArctile.do (GET 방식, POST방식) >> 요청 method (GET), method(POST)
하나의 요청 : 화면, 처리
...
public class NewArticleController {
    ...
    public String form() {
      ...
      // ViewResolver /WEB-INF/views/article/newAricleForm/newArticleForm.jsp
    }
    ...
    /*
     ...
     public String submit(HttpServletRequest request) {
      ...
      article.setParenId(Integer.parseInt(request.getParameter("parentId")));
      ...
      public String submit(NewArticleCommand command)
       ...
       1.1 NewArticleCommand 객체 IOC 컨테이너 안에서 생성 id="newArticleCommand" 자동 생성
            ...
            return mv
       1.2 위 원칙이 없어도 view 페이지에 DTO객체 자동으로 forward (KEY POINT : newArticleCommand 의 이름으로 자동 forward)
     ...
     */
    // @RequestMapping("/article/newArticleOk.do")
    // POST 방식 요청 (글쓰기 처리)
