...
public class HelloApp {
    ...
    /*
     * MyBean mybean = new MyBean(); MyBean mybean2 = new MyBean("hong");
     * 
     * Singleton single = Singleton.getInstance(); Singleton single2 =
     * Singleton.getInstance();
     * 
     * // 참조변수의 주소값 System.out.println("mybean :  " + mybean);
     * System.out.println("mybean2 :  " + mybean2); System.out.println("single :  "
     * + single); System.out.println("single2 :  " + single2);
     */
        ...
        // 주의 !!! : getbean() 호출할때마다 새로운 객체를 만들지 않는다(X)
        
        // 모든 객체 타입 (컨테이너) : default (singleton)
