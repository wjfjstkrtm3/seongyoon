...
<body>
	...
	<!-- 
	 ...
	 <h3>EL & JSTL 사용해서 (디자인 마음대로) 2~9단 출력</h3>
	 <c:forEach var = "i" begin = "2" end = "9">
	 <br>
	 ${i}단
	 	<c:forEach var = "j" begin = "1" end = "9">
	 		<li style = "display:inline">${i}*${j} = ${i*j}</li>
	 	</c:forEach>
	 	<br>
	 ...
	 <%
	 /*
	 객체 만들거나 ... 주소값 처리하는 것은 JAVA가 담당 
	 객체를 출력(화면에 보여주기) -> EL, JSTL
	 */
...
<h3>******* EL은 JAVA 객체 직접 접근 불가 >>>> request, session, application 담거나
	...
	<hr>
	 ...
	 <hr>
	 <h3>***********forEach items 사용하기 서버코드의 주소값 활용하기(c:set) *********</h3>
