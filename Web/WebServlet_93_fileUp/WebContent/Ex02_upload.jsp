...
<%
	...
	// C:\Users\wjfjs\Documents\seongyoon\Web\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebServlet_93_FileUpload\/upload
	
	// cos.jar 파일에서 제공하는 MultilpartRequest 객체 사용
	
	// 업로드 파일에 대한 기본 정보 세팅
	int size = 1024*1024*10; // 10M 네이버 계산기 나중에 뚜들겨 보기
	String name = "";
	String title = "";
	String filename1 = "";
	String filename2 = "";
	...
	MultipartRequest multi = new MultipartRequest(
			...
			size, // 10M
			"UTF-8",
			new DefaultFileRenamePolicy()// 파일 중복(upload 폴더 안에 : a.jpg -> a_1.jpg(업로드 파일명을 변경해줌))
			); // 파일 업로드 완료
...
// 	String hid = request.getParameter("hid");
	...
	// input type = "file" name = "filename1" filename1을 읽으려고 getFileNames()를 쓴다
	// input type = "file" name = "filename2" filename2을 읽으려고 getFileNames()를 쓴다
...
// 	out.print("filename2 : "  + filename2 + "<br>");	   // a1.jpg
// 	out.print("orifilename2 : "  + orifilename2 + "<br>"); // a.jpg
...
// 	out.print("filename1 : "  + filename1 + "<br>");	   // a1.jpg
// 	out.print("orifilename1 : "  + orifilename1 + "<br>"); // a.jpg

	out.print("name : " + name + "<br>");
	out.print("title : " + title + "<br>");
	out.print("hid : " + hid + "<br>");
	out.print("file2 : " + filename2 + "<br>");
